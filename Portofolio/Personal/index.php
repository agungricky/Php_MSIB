...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h1><a href="index.html">RICKY AGUNG SUMIRANTO</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>I'm a passionate <span> Fullstack Web</span> from Kediri</h2>

      <?php 
        require_once 'navbar.php';
        require_once 'sosial_media.php';
      ?>
...
<section id="resume" class="resume">
  <?php 
      include_once 'pengalaman_kerja.php';
    ?>
</section>
